...
final transactionItemApiRepositoryProvider = Provider<TransactionItemApiRepository>((ref) => TransactionItemApiRepository(ref.watch(genericCrudRepositoryProvider)));

class TransactionItemApiRepository {
  const TransactionItemApiRepository(this._crud);
  final GenericCrudRepository _crud;
  static const endpoint = '/transaction-items';
