...
final stockMovementRepositoryProvider = Provider<StockMovementRepository>((ref) => StockMovementRepository(ref.watch(genericCrudRepositoryProvider)));

class StockMovementRepository {
  const StockMovementRepository(this._crud);
  final GenericCrudRepository _crud;
  static const endpoint = '/stock-movements';
