...
final cashSessionRepositoryProvider = Provider<CashSessionRepository>((ref) => CashSessionRepository(ref.watch(genericCrudRepositoryProvider)));

class CashSessionRepository {
  const CashSessionRepository(this._crud);
  final GenericCrudRepository _crud;
  static const endpoint = '/cash-sessions';
