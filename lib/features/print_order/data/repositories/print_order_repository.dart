...
final printOrderRepositoryProvider = Provider<PrintOrderRepository>((ref) => PrintOrderRepository(ref.watch(genericCrudRepositoryProvider)));

class PrintOrderRepository {
  const PrintOrderRepository(this._crud);
  final GenericCrudRepository _crud;
  static const endpoint = '/print-orders';
