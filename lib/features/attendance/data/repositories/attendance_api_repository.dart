...
final attendanceApiRepositoryProvider = Provider<AttendanceApiRepository>((ref) => AttendanceApiRepository(ref.watch(genericCrudRepositoryProvider)));

class AttendanceApiRepository {
  const AttendanceApiRepository(this._crud);
  final GenericCrudRepository _crud;
  static const endpoint = '/attendances';
