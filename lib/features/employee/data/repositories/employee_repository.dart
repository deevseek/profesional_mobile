...
final employeeRepositoryProvider = Provider<EmployeeRepository>((ref) => EmployeeRepository(ref.watch(genericCrudRepositoryProvider)));

class EmployeeRepository {
  const EmployeeRepository(this._crud);
  final GenericCrudRepository _crud;
  static const endpoint = '/employees';
