...
final warrantyRepositoryProvider = Provider<WarrantyRepository>((ref) => WarrantyRepository(ref.watch(genericCrudRepositoryProvider)));

class WarrantyRepository {
  const WarrantyRepository(this._crud);
  final GenericCrudRepository _crud;
  static const endpoint = '/warranties';
