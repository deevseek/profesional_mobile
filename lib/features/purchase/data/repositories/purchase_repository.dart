...
final purchaseRepositoryProvider = Provider<PurchaseRepository>((ref) => PurchaseRepository(ref.watch(genericCrudRepositoryProvider)));

class PurchaseRepository {
  const PurchaseRepository(this._crud);
  final GenericCrudRepository _crud;
  static const endpoint = '/purchases';
