...
final purchaseItemRepositoryProvider = Provider<PurchaseItemRepository>((ref) => PurchaseItemRepository(ref.watch(genericCrudRepositoryProvider)));

class PurchaseItemRepository {
  const PurchaseItemRepository(this._crud);
  final GenericCrudRepository _crud;
  static const endpoint = '/purchase-items';
