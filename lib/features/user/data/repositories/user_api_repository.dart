...
final userApiRepositoryProvider = Provider<UserApiRepository>((ref) => UserApiRepository(ref.watch(genericCrudRepositoryProvider)));

class UserApiRepository {
  const UserApiRepository(this._crud);
