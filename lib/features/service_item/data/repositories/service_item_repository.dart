...
final serviceItemRepositoryProvider = Provider<ServiceItemRepository>((ref) => ServiceItemRepository(ref.watch(genericCrudRepositoryProvider)));

class ServiceItemRepository {
  const ServiceItemRepository(this._crud);
  final GenericCrudRepository _crud;
  static const endpoint = '/service-items';
