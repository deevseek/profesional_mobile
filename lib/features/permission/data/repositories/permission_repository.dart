...
final permissionRepositoryProvider = Provider<PermissionRepository>((ref) => PermissionRepository(ref.watch(genericCrudRepositoryProvider)));

class PermissionRepository {
  const PermissionRepository(this._crud);
  final GenericCrudRepository _crud;
  static const endpoint = '/permissions';
