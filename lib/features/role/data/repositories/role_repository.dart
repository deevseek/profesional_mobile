...
final roleRepositoryProvider = Provider<RoleRepository>((ref) => RoleRepository(ref.watch(genericCrudRepositoryProvider)));

class RoleRepository {
  const RoleRepository(this._crud);
  final GenericCrudRepository _crud;
  static const endpoint = '/roles';
